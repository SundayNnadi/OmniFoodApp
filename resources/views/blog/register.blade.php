...
<div class="button-section">
        ...
        <input class="button"type="text" placeholder="Username" id="username" required>
        <input class="button @error ('password') is-valid @enderror" name="password" type="password" placeholder="Password" id="password" required autocomplete="new-password" name="username">
